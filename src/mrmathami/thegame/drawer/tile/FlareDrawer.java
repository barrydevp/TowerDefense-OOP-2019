...
public final class FlareDrawer implements EntityDrawer {
	@Override
	public void draw(int tickCount, GraphicsContext graphicsContext, GameEntity entity, float screenPosX, float screenPosY, float screenWidth, float screenHeight, float zoom) {
