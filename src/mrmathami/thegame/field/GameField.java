...
public final class GameField {
	private final Set<GameEntity> entities = new LinkedHashSet<>(Config.TILE_MAP_COUNT);
	private final Collection<GameEntity> unmodifiableEntities = Collections.unmodifiableCollection(entities);
	private final List<GameEntity> spawnEntities = new ArrayList<>(Config.TILE_MAP_COUNT);
