...
public final class GameEntities {
	...
	boolean isCollidable( Class<TypeA> entityClassA, Class<TypeB> entityClassB) {
	...
	private static final class Pair {
		private final Class<? extends GameEntity> classA;
		private final Class<? extends GameEntity> classB;

		private Pair(Class<? extends GameEntity> classA, Class<? extends GameEntity> classB) {
			this.classA = classA;
			this.classB = classB;
		}
