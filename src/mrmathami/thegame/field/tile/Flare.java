...
public final class Flare extends AbstractEntity implements UpdatableEntity, EffectEntity, DestroyableEntity, GameEntity {
	...
	private boolean spawnFlare(GameField field, int tickCount, int posX, int posY, int direction) {
	...
	@Override
	public void doEffect(GameField field, int tickCount, LivingEntity livingEntity) {
