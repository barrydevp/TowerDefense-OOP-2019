...
public final class Player extends AbstractEntity implements PlayerEntity, UpdatableEntity, LivingEntity, GameEntity {
	...
	private static boolean checkCollisionSafe(GameField field, float posX, float posY, float width, float height) {
	...
	private static boolean checkBombSpawnSafe(GameField field, int posX, int posY) {
	...
	@Override
	public void doUpdate(GameField field, int tickCount) {
